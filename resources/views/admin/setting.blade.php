                                    ...
                                    <div class="tab-content" id="v-pills-tabContent">
                                        <div class="pt_0 tab-pane fade show active" id="v-1" role="tabpanel"
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="text" class="form-control" name="video_total"
                                                    value="{{ $setting_data->video_total }}">
                                            </div>
                                            <div class="form-group mb-3">
                                                <label>Video Item Status</label>
                                                <select name="video_status" class="form-control">
                                                    <option value="Show"
                                                        @if ($setting_data->video_status == 'Show') selected @endif>Show</option>
                                                    <option value="Hide"
                                                        @if ($setting_data->video_status == 'Hide') selected @endif>Hide</option>
                                                </select>
                                            </div>
                                            <!-- Home Page End -->
                                        </div>
                                        ...
                                        <div class="pt_0 tab-pane fade" id="v-2" role="tabpanel"
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <div>
                                                    <img src="{{ asset('uploads/' . $setting_data->favicon) }}"
                                        ...
                                        <div class="pt_0 tab-pane fade" id="v-3" role="tabpanel"
                                            aria-labelledby="v-3-tab">
                                            <!-- Top Bar Start -->
                                            <div class="form-group mb-3">
                                                <label>Date Status</label>
                                                <select name="top_bar_date_status" class="form-control">
                                                    <option value="Show"
                                                        @if ($setting_data->top_bar_date_status == 'Show') selected @endif>Show</option>
                                                    <option value="Hide"
                                                        @if ($setting_data->top_bar_date_status == 'Hide') selected @endif>Hide</option>
                                                </select>
                                            </div>
                                            <div class="form-group mb-3">
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <select name="top_bar_email_status" class="form-control">
                                                    <option value="Show"
                                                        @if ($setting_data->top_bar_email_status == 'Show') selected @endif>Show</option>
                                                    <option value="Hide"
                                                        @if ($setting_data->top_bar_email_status == 'Hide') selected @endif>Hide</option>
                                                </select>
                                            </div>
                                            <!-- Top Bar End -->
                                        </div>
                                        <div class="pt_0 tab-pane fade" id="v-4" role="tabpanel"
                                            aria-labelledby="v-4-tab">
                                            <!-- Theme Color Start -->
                                            <div class="form-group mb-3">
                                                <label>Theme Color 1</label>
                                                <input type="text" class="form-control jscolor" name="theme_color_1"
                                                    value="{{ $setting_data->theme_color_1 }}">
                                            </div>
                                            <div class="form-group mb-3">
                                                <label>Theme Color 2</label>
                                                <input type="text" class="form-control jscolor" name="theme_color_2"
                                                    value="{{ $setting_data->theme_color_2 }}">
                                            </div>
                                            <!-- Theme Color End -->
                                        </div>
                                        <div class="pt_0 tab-pane fade" id="v-5" role="tabpanel"
                                            aria-labelledby="v-5-tab">
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <select name="analytic_status" class="form-control">
                                                    <option value="Show"
                                                        @if ($setting_data->analytic_status == 'Show') selected @endif>Show</option>
                                                    <option value="Hide"
                                                        @if ($setting_data->analytic_status == 'Hide') selected @endif>Hide</option>
                                                </select>
                                            </div>
                                            <!-- Google Analytic End -->
                                        </div>

                                        <div class="pt_0 tab-pane fade" id="v-6" role="tabpanel"
                                            aria-labelledby="v-6-tab">
                                            <!-- Disqus Comment Start -->
                                            <div class="form-group mb-3">
                                                <label>Disqus Code</label>
                                                <textarea name="disqus_code" class="form-control" cols="30" rows="10" style="height: 200px;">
                                                {{ $setting_data->disqus_code }}</textarea>
                                            </div>
                                            <!-- Disqus Comment End -->
                                        </div>
                                    </div>
